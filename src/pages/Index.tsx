...
import { ArrowRight, Shield, Truck, FlaskConical, BarChart3, Users, Package, Phone, Sparkles, Droplets, SprayCan } from "lucide-react";
...
const products = [
  { icon: Sparkles, name: "Skin Care", desc: "Moisturizers, lotions, creams, and serums" },
  { icon: Droplets, name: "Hair Care", desc: "Shampoos, conditioners, and treatments" },
  { icon: SprayCan, name: "Household Cleaners", desc: "Detergents, disinfectants, and sanitizers" },
  { icon: FlaskConical, name: "Industrial Chemicals", desc: "Bulk chemical solutions for commercial use" },
  { icon: Shield, name: "Personal Hygiene", desc: "Soaps, hand wash, and body care" },
  { icon: Package, name: "Custom Formulations", desc: "Tailored products to your specifications" },
];
        ...
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-14">
            ...
            <motion.p variants={fadeUp} custom={1} className="text-muted-foreground max-w-md mx-auto">
              High-quality cosmetic and household chemical products manufactured to international standards.
            </motion.p>
          </motion.div>

          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((p, i) => (
              <motion.div
                key={p.name}
                variants={fadeUp}
              ...
              >
                <div className="h-12 w-12 rounded-lg bg-accent/10 text-accent flex items-center justify-center mb-4 group-hover:gradient-accent group-hover:text-accent-foreground transition-all">
